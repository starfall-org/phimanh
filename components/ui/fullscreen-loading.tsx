...
export default function FullscreenLoading({ transparent = true }: FullscreenLoadingProps) {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background/80 dark:bg-black/60 backdrop-blur-md">
      {/* Background Decorations - Simplified for performance */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-red-600/10 dark:bg-red-600/5 blur-[120px] animate-pulse"></div>
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-red-900/10 dark:bg-red-900/5 blur-[120px] animate-pulse"
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-32 h-32 mb-12">
          ...
          {/* Spinning Ring 2 */}
          <div
            className="absolute inset-4 border-[3px] border-foreground/20 dark:border-white/40 border-b-transparent rounded-full animate-spin"
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 bg-red-600 rounded-lg rotate-45 flex items-center justify-center animate-pulse">
              <div className="w-4 h-4 bg-white dark:bg-black rounded-full -rotate-45"></div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center space-y-4 px-6">
          <h2 className="text-3xl font-black tracking-tighter uppercase italic text-foreground dark:text-white">
